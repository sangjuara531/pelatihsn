			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li class="text-center">
						<img src="https://static.vecteezy.com/system/resources/thumbnails/009/636/683/small_2x/admin-3d-illustration-icon-png.png" class="user-image img-responsive"/>
					</li>
					<!-- <li>
					...
					<li>
						<a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i>Data Penjualan</a>
					</li>
					<!-- <li>
						<a href="index.php?halaman=laporan_pembelian"><i class="fa fa-file"></i>Laporan</a>
					</li> -->
					<li>
						<a href="index.php?halaman=pelanggan"><i class="fa fa-user"></i>Data User</a>
					</li>
					<li>
